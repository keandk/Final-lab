...
KEY_SUPPLEMENTAL_ENTRY_SIZE = METADATA_SUPPLEMENTAL_ENTRY_SIZE
KEY_FILENAME_LEN = METADATA_FILENAME_LEN
KEY_ORIGINAL_PATH_LEN = METADATA_ORIGINAL_PATH_LEN
KEY_PER_FILE_PW_VERIFIER_LEN = METADATA_PER_FILE_PW_VERIFIER_LEN
KEY_FILE_CONTENT_CHECKSUM_LEN = METADATA_FILE_CONTENT_CHECKSUM_LEN 